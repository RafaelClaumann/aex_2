...
VALUES
    (28.90, 1, 'Pão brioche, hambúrguer artesanal 180g, queijo, alface, tomate e maionese da casa.', 'Clássico da Casa'),
...
INSERT INTO pedido (valor, cliente_id, data_criacao, status)
VALUES
    (76.80, 1, NOW(), 'FINALIZADO'),    -- pedido 1 - 28.90 + 31.90 + (6*2) = 76.80
    (70.00, 1, NOW(), 'EM_ANDAMENTO'),  -- pedido 2 - 42.00 + (14*2) = 70.00
    (39.50, 2, NOW(), 'FINALIZADO');    -- pedido 3 - 27.50 + 12.00 = 39.50
...
VALUES
    (28.90, 1, 1, 1),   -- 1x Clássico da Casa no pedido 1
...
INSERT INTO pagamento (valor_pago, pedido_id, forma_pagamento, status_pagamento)
VALUES
    (76.80, 1, 'CARTAO_CREDITO', 'PAGO'),
    (70.00, 2, 'PIX', 'PAGO'),
    (39.50, 3, 'DINHEIRO', 'PAGO');
